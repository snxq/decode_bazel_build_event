...
func (OptionEffectTag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_option_filters_6e27afedc69ce398, []int{0}
}
...
func (OptionMetadataTag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_option_filters_6e27afedc69ce398, []int{1}
}
...
func init() {
	proto.RegisterFile("src/main/protobuf/option_filters.proto", fileDescriptor_option_filters_6e27afedc69ce398)
}

var fileDescriptor_option_filters_6e27afedc69ce398 = []byte{
